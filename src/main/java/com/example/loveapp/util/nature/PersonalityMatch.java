...
public class PersonalityMatch {
    ...
    public static List<User> getBestMatches(User targetUser, List<User> allUsers ) {

        List<UserScore> userScores = new ArrayList<>();

        for (User user : allUsers) {
            Double overallScore = getCosineSimilarity(targetUser.getPersonality(), user.getPersonality());
