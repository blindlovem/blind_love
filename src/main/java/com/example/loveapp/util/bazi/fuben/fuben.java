...
public class fuben {
    ...
    public class WuXingApp {
        private static List<String> wuxingList_;
        private static List<String> queList_;
        ...
        public static void wuxing(String gzYear, String gzMonth, String gzDay, String gzTime) {
            ...
            wuxingList.add(gYear);
            wuxingList.add(zYear);
            wuxingList.add(gMonth);
            wuxingList.add(zMonth);
            wuxingList.add(gDay);
            wuxingList.add(zDay);
            wuxingList.add(gTime);
            wuxingList.add(zTime);

            wuxingList_ = wuxingList;
