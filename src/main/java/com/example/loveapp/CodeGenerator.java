...
//        dataSource.setUrl("jdbc:mysql://localhost:3306/db_loveapp?serverTimezone=UTC");
//        dataSource.setUsername("root");
//        dataSource.setPassword("LXYlxy12345");
...
//        globalConfig.setAuthor("yuyu6");    //设置作者
...
//        packageInfo.setParent("com.example.loveapp");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
